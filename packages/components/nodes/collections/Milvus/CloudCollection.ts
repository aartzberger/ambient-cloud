...
import { checkJsonString, default_url } from './core'

// TODO CMAN - chang this for input
const OPENAI_API_KEY = process.env.OPENAI_API_KEY

class Cloud_Existing_Collection implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'Load Cloud Collection'
        this.name = 'cloudCollection'
        this.version = 2.0
        this.type = 'CloudCollection'
        this.icon = 'cloud-data.svg'
        this.category = 'Collections'
        this.description = 'Load a collection hosted by AmbientWare!'
...
module.exports = { nodeClass: Cloud_Existing_Collection }

...
export const default_url = process.env.MILVUS_CLOUD_URL || 'vectordb:19530' // vectordb will be container name on same aws network

export class MilvusUpsert extends Milvus {
...
export function checkJsonString(value: string): { isJson: boolean; obj: any } {
    try {
